...
public class CT02_1DisciplinaVazio {
    ...
    public void setUp() {
        try {
            ...
            buffer = new BufferedReader(new FileReader("E:\\GitHub\\testesRp2\\src\\main\\resources\\CT02_1.json"));
    ...
    public void CT01() throws InterruptedException {
        ...
        responderQuestionario(navegador, espera, actions, unidade, turma, comunicacao, nomeQuest);
    }
    ...
    public void responderQuestionario(WebDriver navegador, WebDriverWait espera, Actions actions, String unidade, String turma, String comunicacao, String nomeQuest) throws InterruptedException {
        ...
        String textoMensagemErro = mensagemErro.getText();
        Assertions.assertEquals("O campo Disciplina é obrigatório.", textoMensagemErro);
        System.out.println("O campo Disciplina é obrigatório.");
    }
}
