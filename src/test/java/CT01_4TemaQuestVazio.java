...
public class CT01_4TemaQuestVazio {
    ...
    public void setUp() {
        try {
            ...
            buffer = new BufferedReader(new FileReader("E:\\GitHub\\testesRp2\\src\\main\\resources\\CT01_4.json"));
    ...
    public void criarQuestionario(WebDriver navegador, WebDriverWait espera, Actions actions, String nomeQuest, String qtdPerguntas
        ...
        Assertions.assertEquals("O campo Tema não pode ter menos de 50 caracteres", textoMensagemErro);
        System.out.println("O campo Tema não pode ter menos de 50 caracteres");

        //deu erro mas a mensagem "errada"
    }
}
