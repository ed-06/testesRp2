...
public class CT01_4TemaQuestVazio {
    ...
    public void setUp() {
        try {
            ...
            buffer = new BufferedReader(new FileReader("C:\\Users\\eduar\\Documents\\GitHub\\testesRp2\\src\\main\\resources\\CT01_4.json"));
    ...
    public void criarQuestionario(WebDriver navegador, WebDriverWait espera, Actions actions, String nomeQuest, String qtdPerguntas
        ...
        Assertions.assertEquals("O campo Tema é obrigatório.", textoMensagemErro);
        System.out.println("O campo Tema é obrigatório.");
    }
}
