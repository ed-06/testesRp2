...
public class CT01_1NomeQuestVazio {
    ...
    public void setUp() {
        try {
            ...
            buffer = new BufferedReader(new FileReader("E:\\GitHub\\testesRp2\\src\\main\\resources\\CT01_1.json"));
    ...
    public void criarQuestionario(WebDriver navegador, WebDriverWait espera, Actions actions, String nomeQuest, String qtdPerguntas
        ...
        Assertions.assertEquals("O campo Questionário é obrigatório.", textoMensagemErro);
        System.out.println("O campo Questionário é obrigatório.");
    }
}