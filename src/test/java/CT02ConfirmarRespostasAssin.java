...
public class CT02ConfirmarRespostasAssin {
    ...
    public void setUp() {
        try {
            ...
            buffer = new BufferedReader(new FileReader("E:\\GitHub\\testesRp2\\src\\main\\resources\\CT02Assinc.json"));
    ...
    public void CT01() throws InterruptedException {
        ...
        String comunicacao = jsonObject.get("comunicacao").getAsString();
        ...
        responderQuestionario(navegador, espera, actions, unidade, turma, disciplina, comunicacao, nomeQuest);
    }
    ...
    public void responderQuestionario(WebDriver navegador, WebDriverWait espera, Actions actions, String unidade, String turma, String disciplina, String comunicacao, String nomeQuest) throws InterruptedException {
        ...
        for (int k = 0; k < 3; k++) {
            ...
            if (k == 0) {
                sleep(500);
                // Localiza o campo de input pelo XPath
                WebElement inputField = navegador.findElement(By.xpath("/html/body/span/span/span[1]/input"));
                // Clica no campo para focar
                inputField.click();
                // Pausa para garantir que o campo está em foco
                sleep(500);
                // Envia o valor de 'unidade'
                inputField.sendKeys(unidade);
                // Pausa adicional para garantir a entrada do valor
                sleep(1000);
                // Envia a tecla ENTER
                ...
                // Pausa de 500ms antes de interagir com o campo
                sleep(500);
                // Localiza o campo de input pelo XPath
                WebElement inputField = navegador.findElement(By.xpath("/html/body/span/span/span[1]/input"));
                // Clica no campo para focar
        ...
        navegador.findElement(By.name("comunicacao")).sendKeys(comunicacao);
        ...
        //ok no teste
        espera.until(d -> navegador.findElement(By.xpath("/html/body/div[2]/div/div/div[3]/button"))).click();
        sleep(1000);

        try {
            Assertions.assertEquals("http://200.132.136.72/AIQuiz2/index.php?class=QuestionarioList&method=onReload",
                    navegador.getCurrentUrl());
            System.out.println("Questionario criado com sucesso");
        } catch (AssertionError e) {
            System.out.println("Erro na criação do questionario!");
        }
    }
}