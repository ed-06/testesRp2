...
public class CT01_3QtdAlternaVazio {
    ...
    public void setUp() {
        try {
            ...
            buffer = new BufferedReader(new FileReader("E:\\GitHub\\testesRp2\\src\\main\\resources\\CT01_3.json"));
    ...
    public void criarQuestionario(WebDriver navegador, WebDriverWait espera, Actions actions, String nomeQuest, String qtdPerguntas
        ...
        System.out.println("O teste foi gerado com sucesso, porque mesmo com o campo quantidade de alternativas vazio," +
