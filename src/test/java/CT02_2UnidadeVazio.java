...
public class CT02_2UnidadeVazio {
    ...
    public void setUp() {
        try {
            ...
            buffer = new BufferedReader(new FileReader("E:\\GitHub\\testesRp2\\src\\main\\resources\\CT02_2.json"));
    ...
    public void CT01() throws InterruptedException {
        ...
        responderQuestionario(navegador, espera, actions, turma, disciplina, comunicacao, nomeQuest);
    }
    ...
    public void responderQuestionario(WebDriver navegador, WebDriverWait espera, Actions actions, String turma, String disciplina, String comunicacao, String nomeQuest) throws InterruptedException {
        ...
        String textoMensagemErro = mensagemErro.getText();
        Assertions.assertEquals("O campo Unidade é obrigatório.\n" +
                "O campo Turma é obrigatório.\n" +
                "O campo Disciplina é obrigatório.", textoMensagemErro);
        System.out.println("O campo Unidade é obrigatório.\n" +
                "O campo Turma é obrigatório.\n" +
