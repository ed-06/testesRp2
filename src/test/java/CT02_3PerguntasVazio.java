...
public class CT02_3PerguntasVazio {
    ...
    public void setUp() {
        try {
            ...
            buffer = new BufferedReader(new FileReader("E:\\GitHub\\testesRp2\\src\\main\\resources\\CT02_3.json"));
    ...
    public void responderQuestionario(WebDriver navegador, WebDriverWait espera, Actions actions, String unidade, String turma, String disciplina, String comunicacao, String nomeQuest) throws InterruptedException {
        ...
        //deixar de selecionar as perguntas
        espera.until(d -> navegador.findElement(By.name("check1"))).click();
        espera.until(d -> navegador.findElement(By.name("check2"))).click();
        espera.until(d -> navegador.findElement(By.name("check3"))).click();
        espera.until(d -> navegador.findElement(By.name("check4"))).click();
        ...
        String textoMensagemErro = mensagemErro.getText();
        Assertions.assertEquals(textoMensagemErro, textoMensagemErro);
        System.out.println(textoMensagemErro);
    }
}
