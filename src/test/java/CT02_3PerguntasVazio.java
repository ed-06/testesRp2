...
public class CT02_3PerguntasVazio {
    ...
    public void responderQuestionario(WebDriver navegador, WebDriverWait espera, Actions actions, String disciplina, String resposta) throws InterruptedException {
        ...
        //Respostas
        //1
        espera.until(d -> navegador.findElement(By.name("check1")));
        navegador.findElement(By.name("check1")).click();
        //2
        espera.until(d -> navegador.findElement(By.name("check2")));
        navegador.findElement(By.name("check2")).click();
        //3
        espera.until(d -> navegador.findElement(By.name("check3")));
        navegador.findElement(By.name("check3")).click();
        //4
        espera.until(d -> navegador.findElement(By.name("check4")));
        navegador.findElement(By.name("check4")).click();
